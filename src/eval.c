...
eval_bytecode(context_t context, registers_t regs, bytecode_t bc)
{
    ...
    case BOP_CALL:
        ...
        tmp = eval_call(context, bc.pos, left, right);
        dynarr_object_ptr_append(stack, &tmp);
        object_deref(left);
        object_deref(right);
        break;
    case BOP_MAP:
        ...
        tmp = eval_map(context, bc.pos, left, right);
        dynarr_object_ptr_append(stack, &tmp);
        object_deref(left);
        object_deref(right);
        break;
    case BOP_FILTER:
        ...
        tmp = eval_filter(context, bc.pos, left, right);
        dynarr_object_ptr_append(stack, &tmp);
        object_deref(left);
        object_deref(right);
        break;
    case BOP_REDUCE:
        ...
        tmp = eval_reduce(context, bc.pos, left, right);
        dynarr_object_ptr_append(stack, &tmp);
        object_deref(left);
        object_deref(right);
        break;
